      ...
      <div className="relative z-10 max-w-6xl mx-auto p-6">
        ...
        {activeLock && (
          <div className="mt-16" id={`puzzle-${activeLock}`}>
            {/* Always show the image section when a question is active */}
            <div className="mb-8">
                    ...
                    <div className="bg-gray-800 border-2 border-cyan-400 rounded-lg p-8 text-center min-w-[400px]">
                      ...
                      <p className="text-blue-400 text-sm mb-4">
                        {isImageExpected(activeLock) ? 
                          `Missing expected image for Group ${studentInfo.groupNumber}` :
                          `No image configured for this question in Group ${studentInfo.groupNumber}`
                        }
                      </p>
                      {isImageExpected(activeLock) && (
